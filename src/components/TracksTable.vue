  ...
  data() {
    const headers = [
      ...
      },
      {
        ...
        value: "title",
        class: "text-no-wrap",
        sortRaw: (t1, t2) => compareStrings(t1.normalized_title, t2.normalized_title),
      },
      {
      ...
      },
      {
        ...
        width: "1px",
        class: "text-no-wrap",
        sortRaw: (t1, t2) => (this.playStatsByTrack[t1.id]?.count || 0) - (this.playStatsByTrack[t2.id]?.count || 0),
      },
      {
